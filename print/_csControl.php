...
select substring_index(ld_supplierName,' ',2)ld_supplierName,truckControlNo,tripTTV,truckLicense,truckType,driverName,phone,planTimeOut,planTimeIn,
routeTrip,ld_dueTime,ld_supplierCode,date_format(ld_dueDate,'%d-%m-%y') ld_dueDate,ud_dueTime,bol
from tbl_pickupheader ph where bol='$doctype' and ediStatus='ACTIVE' order by ph.ld_dueDate,ph.ld_dueTime;

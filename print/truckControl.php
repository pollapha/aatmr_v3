...
SELECT t2.StopSequenceNumber s5_seq,substring_index(t2.Supplier_Name, ',', 1)ld_supplierName,'' tripTTV,t1.Load_ID truckControlNo,t1.truckLicense,t1.truckType,t1.driverName,t1.phone,t1.planTimeOut_Origin planTimeOut,t1.planTimeIn_Origin planTimeIn,t1.Load_ID bol,
...
where t1.Load_ID='$doctype' GROUP BY
substring_index(t2.Supplier_Code, '-', 1) order by t2.StopSequenceNumber ;
...
function createHeader($pdf,$totalPage)
{
    ...
    $pdf->Image("http://localhost/aatmr_v3/php/genqrpng.php?text=".$url, 25, 165, 25, 25, "png");

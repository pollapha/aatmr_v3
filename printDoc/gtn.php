...
if(strlen($printerName) == 0 || strlen($doctype) == 0 || strlen($printType) == 0 || strlen($warter) == 0 || $copy == 0) 
 ...
 class PDF extends PDF_Code128
 {
    ...
    function Header()
    {
      ...
      $header->easyCell(utf8Th("Ship To :"), 'valign:M;align:R;');
...
function subTotal($header,$totalQty)
{

  $header->easyCell(utf8Th('Sub Total'), 'valign:M;align:R;colspan:3');
...
function Total($header,$totalQty)
{
  ...
  $header->easyCell(utf8Th('Total'), 'valign:M;align:R;colspan:3');
  $header->easyCell(utf8Th($totalQty), 'valign:M;align:R;');
  $header->easyCell(utf8Th(''), 'valign:M;align:C;');
  $header->printRow();
}

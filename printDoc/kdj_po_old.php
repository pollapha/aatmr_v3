...
$tbody = array();
 ...
 t1.Ship_To,t1.Remarks,t5.Trader_Code,t5.Trader_Name,t5.Telephone_Number,t2.Customer_Project,t5.Credit_Term,
 concat(
 ...
 t2.Qty,t2.Unit_Price,t2.Qty*t2.Unit_Price Amount,t1.Vat Vat,
 ...
 group by t2.Customer_Project,t2.Item_ID order by t2.Customer_Project,t2.Item_ID";
...
class PDF extends PDF_Code128
{
  ...
  function Header()
  {
    ...
    $header->easyCell('', 'border:L;font-style:B;');
    $header->easyCell(strtoupper($v->{'Billing_Address'}), 'align:L;border:R;');
...
/*     $header->easyCell("", 'align:L;border:LB;font-style:B;');
    ...
    $headdetail = new easyTable(
      $this->instance,
      '{15,30,44,74,15,15,15,15,15,15,19,23,20,45}','width:300;border:1;font-family:THSarabun;font-size:11; font-style:B;'
    );
...
$pdf->SetTitle($docno);
$detail = new easyTable($pdf, '{15,30,44,74,15,15,15,15,15,15,19,23,20,45}', 'width:300;border:1;font-family:THSarabun;font-size:10;');
...
while ($i <  $bodyLen) 
{
    ...
    $detail->easyCell(utf8Th($data[$i]->{'Customer_Project'}), 'align:L;');
    $detail->easyCell(utf8Th($data[$i]->{'Supplier_Part_No'}), 'align:L;');
    $detail->easyCell(utf8Th($data[$i]->{'Item_Name'}), 'align:L;');
    ...
    $detail->easyCell(utf8Th($data[$i]->{'Item_Grad'}), 'align:L;colspan:3;font-size:9.5;');

...
/*  $doctype = 'PTNI19020400010';
 ...
 class PDF extends PDF_Code128
 {
    ...
    function Header()
    {
      ...
      $header->easyCell('', 'img:images/ttv-logo.gif, w30,h8;valign:T;align:L');
 ...
 $sumQty = 0;
 $sql = "SELECT 
 t1.Qty*-1 Qty,t1.Document_No,t1.Truck_License,t1.Truck_Type,t1.Driver_Name,t1.Phone,t1.Remarks,
 t1.Document_No_Ref,t1.Creation_Datetime,t1.Created_Name,t1.Updated_Datetime,t1.Updated_Name,
 t2.Package_Type,t2.Package_Name,t1.Balance_End,
 t3.Supplier_Code,t3.Supplier_Name,
 date_format(t1.Creation_Datetime,'%d/%m/%Y') shipDate,date_format(t1.Creation_Datetime,'%H:%i') shipTime

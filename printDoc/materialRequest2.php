...
/*  $doctype = 'ORD19011700006';
 ...
 class PDF extends PDF_Code128
 {
    ...
    function Header()
    {
      ...
      , 'valign:T;align:L');
      $header->printRow();
      $header->easyCell('ORDER PICKING SHEET', 'valign:M;align:C;colspan:2;font-size:10;border:TB');
      $header->printRow();
      $header->endTable(0);
      ...
      $header->easyCell(utf8Th("Delivery Department"), 'valign:M;align:R;');
      ...
      $header->easyCell(utf8Th($v->Material_Type.' ('.$v->Shop.')'), 'valign:M;align:L;');
 ...
 $sumLine = 0;
 $sumQty = 0;
 $sql = "SELECT t1.Document_No,t1.Document_Type,t1.Material_Type,date_format(t1.Document_Datetime,'%d-%m-%Y %H:%i')Document_Datetime,
 ...
 t2.Qty,t2.Qty_Picking,t2.Remarks_Body,t1.Created_Name Order_By,date_format(t1.Document_Date,'%d-%m-%Y')Document_Date,
 t3.Part_Number,t3.Part_Name,t3.UOM,t5.Location,t8.Dep_Name,t10.Shop
 ...
 left join tbl_user t7 on t1.Created_By=t7.user_id
 left join tbl_department t8 on t7.user_dep=t8.ID
 left join tbl_nm_partmaster_detail t10 on t2.Part_ID=t10.Part_ID

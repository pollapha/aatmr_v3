...
else if($type>20 && $type<=30)//update
{
	...
	if($type == 21)
	{
		...
		'obj=>ActualIN_Datetime','obj=>ActualOut_Datetime'));
		if(count($chkPOST) > 0) closeDBT($mysqli,2,join('<br>',$chkPOST));
		...
		$ActualIN_Datetime = checkTXT($mysqli,$_POST['obj']['ActualIN_Datetime']);
		$ActualOut_Datetime = checkTXT($mysqli,$_POST['obj']['ActualOut_Datetime']);

		/* var_dump($ActualIN_Datetime);
		var_dump($ActualOut_Datetime); */
		/* var_dump($acDocTime);

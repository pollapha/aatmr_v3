...
where t3.Start_Datetime between date_add(now(), INTERVAL -3 day) and date_add(now(), INTERVAL 1 day)
and `Work_Type` in('ADD','BLOWOUT','MISSING_ROUTES','SPECIAL','BAILMENT','RETURN_PACKAGE')
group by t1.Load_ID

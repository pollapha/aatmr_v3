var header_ProjectMaster = function () {
    var menuName = "ProjectMaster_", fd = "MasterData/" + menuName + "data.php";
    ...
    function exportExcel(btn) {
        ...
        if (dataT1.count() > 0) {
            ...
            worker.addEventListener('message', function (e) {
                saveAs(e.data, 'ProjectMaster_' + new Date().getTime() + ".xlsx");
                btn.enable();
                                            ...
                                            width: 170, on:
                                            {
                                                onItemClick: function () {
                                                    ...
                                                    for (i = 0, len = data.length; i < len; i++) {
                                                        if (data[i].projectName.length > 1) {
                                        ...
                                        {},
                                        {
                                                ...
                                                "onAfterEditStop": function (state, editor, ignoreUpdate) {
                                                    ...
                                                    if (state.value != state.old) {
                                                        ...
                                                        if (editor.column == 'projectName') {
                                                            projectName = editor.getValue();
                                                            row_id = editor.row;

                                                            record = grid.getItem(row_id);
                                                            record['projectName2'] = projectName;
                                                            grid.refresh(row_id);
                                                        }
                                            ...
                                            columns:
                                                [
                                                    ...
                                                    { id: "projectName", header: ["Project Name", { content: "textFilter" }], editor: "text", width: 150 },
                                                    // { id: "projectName2", header: ["Project Name2", { content: "textFilter" }], editor: "text", width: 150 },
                                                ],
                                        },
                                        {}
                                    ]

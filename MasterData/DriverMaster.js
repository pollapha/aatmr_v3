                                ...
                                cols:
                                    [
                                        {},
                                        {
                                            ...
                                            rules:
                                            {
                                                fNameTH: function (obj) { return obj.length > 1; },
                                                lNameTH: function (obj) { return obj.length > 1; },
                                                phone: function (obj) { return obj.length > 1; }
                                            },
                                            on:
                                            {
                                            ...
                                            columns:
                                                [
                                                    ...
                                                    { id: "fNameTH", header: ["ชื่อ", { content: "textFilter" }], editor: "text", width: 100 },
                                                    { id: "lNameTH", header: ["นามสกุล", { content: "textFilter" }], editor: "text", width: 100 },
                                                    { id: "phone", header: ["Phone", { content: "textFilter" }], editor: "text", width: 100 },
                                                ],
                                        },
                                        {}
                                    ]
